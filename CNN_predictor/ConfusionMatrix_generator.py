...
file = 'C:/Users/Carter/Desktop/Computer Vision/Group_project/Images/Test_set/'
...
new_predictor = Predictor(model = 'raw_images_ep_50_128x128.h5')
...
for i in range(len(image_paths)):
    file = image_paths[i]
    result, lab_num, confidence = new_predictor.predict_image_class(file,raw_image = False, verbose=0)
